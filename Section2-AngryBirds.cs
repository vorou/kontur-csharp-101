...
namespace AngryBirds
{
	...
	public class ArtilleryTestCase : TestCase
	{
		...
		public ArtilleryTestCase(double v, double distance)
			: base("Artillery")
		{
			this.v = v;
		...
		protected override bool InternalRun()
		{
			...
			angle = FindSightAngle(v, distance);
			double x = 0;
			double y = 0;
	    ...
	    private double FindSightAngle(double v, double distance)
	    {
	        return angle = distance*9.8/(2*Math.Pow(v, 2));
	    }
	}
}